...
echo ""
echo "Next steps:"
echo "  1. Build the gateway: cd gateway && go build -o sovereign-gateway ./cmd/gateway"
echo "  2. Run the gateway (direct mode — checks Memes ERC-1155 on-chain):"
echo ""
echo "     ./sovereign-gateway \\"
echo "       --direct-mode \\"
echo "       --listen :$GATEWAY_PORT \\"
echo "       --eth-rpc 'https://ethereum-rpc.publicnode.com' \\"
echo "       --memes-contract '0x33fd426905f149f8376e227d0c9d3340aad17af1' \\"
echo "       --chain-id 1 \\"
echo "       --this-card-id YOUR_CARD_ID \\"
